...
/* ion-auth config for Global Health repository */
/*
| -------------------------------------------------------------------------
| Database Type
| -------------------------------------------------------------------------
...
| Edited by Fred Riley, 23/1/13
*/
$config['tables']['users']           = 'gh_users';
$config['tables']['groups']          = 'gh_groups';
$config['tables']['users_groups']    = 'gh_users_groups';
$config['tables']['login_attempts']  = 'gh_login_attempts';
...
/*
 ...
 | NB: Admin email has to be in the same domain as the host, else it'll likely be blocked (FR note)
 */
$config['site_title']           = "Global Health repository"; 		// Site Title, example.com
$config['admin_email']          = "fred.riley@gmail.com"; 	// Admin Email, admin@example.com
...
// config parameter below changed by Fred Riley, 6/11/13
