...
INSERT INTO `gh_groups` (`id`, `name`, `description`) VALUES
	...
	(3,'contributor', 'Record contributor');
...
INSERT INTO `gh_users` (`id`, `ip_address`, `username`, `password`, `salt`, `email`, `activation_code`, `forgotten_password_code`, `created_on`, `last_login`, `active`, `first_name`, `last_name`, `company`, `phone`) VALUES
...
CREATE TABLE `gh_login_attempts` (
  `id` mediumint(8) unsigned NOT NULL AUTO_INCREMENT,
  `ip_address` varbinary(16) NOT NULL,
